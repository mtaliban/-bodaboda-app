...
from sqlalchemy import BigInteger, ForeignKey, DECIMAL, Integer, TIMESTAMP, String, func, Enum as SAEnum
...
class DriverProfile(Base):
    ...
    verification_status: Mapped[VerificationStatus] = mapped_column(SAEnum(VerificationStatus, name="verificationstatus"), nullable=False, default=VerificationStatus.VERIFIED)
